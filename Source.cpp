...
void URender()
{
	...
	view = glm::translate(glm::vec3(0.0f, -3.8f, -12.0f));
	...
	///-------Transform and draw the 3-sided pyramid mesh --------
	// Activate the VBOs contained within the mesh's VAO
	...
	///-------Transform and draw the 4-sided pyramid mesh --------
	// Activate the VBOs contained within the mesh's VAO
	...
	///-------Transform and draw the prism mesh --------
	// Activate the VBOs contained within the mesh's VAO
	...
	///-------Transform and draw the cone mesh --------
	// Activate the VBOs contained within the mesh's VAO
